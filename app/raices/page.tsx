...
export default function Raices(){
    ...
    const resolveBisection = (mathField) => {
        ...
        const result = bisection(0, 1, (x) => evaluate(expression, {x: x}) , 0.0001, expression);
        if('error' in result){
            setError(
    ...
    return (
        ...
        <div className="flex  md:pt-[130px] justify-center pb-[300px] ">
            ...
            <h1 className="text-3xl pb-5 text-slate-700">Aproximación de raíces </h1>
            ...
            <ul className="hidden text-sm font-medium text-center text-gray-500 rounded-lg divide-x divide-gray-200 shadow sm:flex dark:divide-gray-700 dark:text-gray-400 mb-6">
                <li className="w-full">
                    <button className="inline-block p-4 w-full text-gray-900 bg-gray-200 rounded-l-lg  active focus:outline-none dark:bg-gray-700 dark:text-white" aria-current="page">Bisección<nav></nav></button>
                </li>
                <li className="w-full">
                    <button className="inline-block p-4 w-full bg-white hover:text-gray-700 hover:bg-gray-50  focus:outline-none dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700">Newton-Raphson</button>
                </li>
                <li className="w-full">
                    <button  className="inline-block p-4 w-full bg-white hover:text-gray-700 hover:bg-gray-50 focus:outline-none dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700">Secante</button>
                </li>
                <li className="w-full">
